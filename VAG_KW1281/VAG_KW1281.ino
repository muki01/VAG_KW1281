...
#define DATA_REQUEST_INTERVAL 20  // Time to wait before sending a new request after receiving a response (55ms - 5000ms)
#define DATA_TIMEOUT 1000         // Time to wait before sending a new request after receiving a response (500ms - 5000ms)
#define DEBUG_Serial
