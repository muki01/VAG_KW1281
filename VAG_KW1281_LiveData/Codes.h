...
uint8_t readROM[5] = { 0x03, 0x09, 0x00, 0x00, 0x03 };
...
uint8_t ECU_Data2_Response[6] = { 0xF6, 0x47, 0x30, 0x30, 0x30, 0x03 };                                                                                                                           // G000 (ASCII)
uint8_t ECU_Data3_Response[10] = { 0xF6, 0x53, 0x47, 0x20, 0x44, 0x30, 0x39, 0x20, 0x20, 0x03 };                                                                                                  // SG D09 (ASCII)
uint8_t ECU_Data4_Response[7] = { 0xF6, 0x00, 0x07, 0xEE, 0x09, 0x15, 0x03 };
